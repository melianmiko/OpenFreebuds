    ...
    async def stop(self):
        ...
        for handler in self.handlers:
            try:
                ...
                log.exception(f"Stop of {handler.handler_id} failed")
...
class OfbDriverHandlerHuawei(OfbDriverHandlerGeneric):
    ...
    async def on_stop(self):
        """
        Release anything this handler owns beyond the SPP session,
        e.g. background tasks that must not outlive the driver.
        """
        pass
